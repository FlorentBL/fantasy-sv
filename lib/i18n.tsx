...
const translations: Record<string, TranslationRow> = {
  ...
  "Goals-conceded deductions are calculated automatically.": [
    "Les pénalités de buts encaissés sont calculées automatiquement.",
    "Le penalità per gol subiti sono calcolate automaticamente.",
    "Las penalizaciones por goles encajados se calculan automáticamente.",
    "Gegentor-Abzüge werden automatisch berechnet.",
    "As penalizações por golos sofridos são calculadas automaticamente.",
  ],

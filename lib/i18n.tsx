...
const translations: Record<string, TranslationRow> = {
  ...
  "Choose a formation, then tap two players to fine-tune your eleven.": [
    "Choisis une formation, puis touche deux joueurs pour affiner ton onze.",
    "Scegli un modulo, poi tocca due giocatori per perfezionare l'undici.",
    "Elige una formación y pulsa dos jugadores para ajustar tu once.",
    "Wähle eine Formation und tippe dann zwei Spieler an, um deine Elf anzupassen.",
    "Escolhe uma formação e toca em dois jogadores para ajustar o onze.",
  ],
  "Formation {formation} selected. Save your team to confirm.": [
    "Formation {formation} sélectionnée. Enregistre ta composition pour confirmer.",
    "Modulo {formation} selezionato. Salva la formazione per confermare.",
    "Formación {formation} seleccionada. Guarda tu equipo para confirmar.",
    "Formation {formation} gewählt. Speichere dein Team zur Bestätigung.",
    "Formação {formation} selecionada. Guarda a equipa para confirmar.",
  ],
  ...
  "My scores": ["Mes scores", "I miei punteggi", "Mis puntuaciones", "Meine Punkte", "As minhas pontuações"],
  "Gameweek score": ["Score par journée", "Punteggio giornata", "Puntuación de la jornada", "Spieltagswertung", "Pontuação da jornada"],
  "Final score": ["Score final", "Punteggio finale", "Puntuación final", "Endstand", "Pontuação final"],
  "Player points": ["Points des joueurs", "Punti dei giocatori", "Puntos de jugadores", "Spielerpunkte", "Pontos dos jogadores"],
  "Transfer cost": ["Coût des transferts", "Costo trasferimenti", "Coste de fichajes", "Transferkosten", "Custo de transferências"],
  "The final score includes captain points, automatic substitutions and transfer costs.": [
    "Le score final inclut le capitaine, les remplacements automatiques et le coût des transferts.",
    "Il punteggio finale include capitano, sostituzioni automatiche e costi dei trasferimenti.",
    "La puntuación final incluye capitán, sustituciones automáticas y costes de fichajes.",
    "Die Endwertung enthält Kapitänspunkte, automatische Wechsel und Transferkosten.",
    "A pontuação final inclui capitão, substituições automáticas e custos de transferências.",
  ],
  "No Fantasy score yet": ["Pas encore de score Fantasy", "Nessun punteggio Fantasy", "Aún no hay puntuación Fantasy", "Noch keine Fantasy-Punkte", "Ainda sem pontuação Fantasy"],
  "Fantasy SV started in gameweek 4. Your score appears here after each completed gameweek.": [
    "Fantasy SV a commencé en J4. Ton score apparaîtra ici après chaque journée terminée.",
    "Fantasy SV è iniziato alla giornata 4. Il punteggio apparirà qui dopo ogni giornata completata.",
    "Fantasy SV comenzó en la jornada 4. Tu puntuación aparecerá aquí después de cada jornada completada.",
    "Fantasy SV begann an Spieltag 4. Deine Punkte erscheinen hier nach jedem abgeschlossenen Spieltag.",
    "O Fantasy SV começou na jornada 4. A tua pontuação aparecerá aqui após cada jornada concluída.",
  ],
